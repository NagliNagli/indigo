...
Please make sure you visit the official publication from @vavkamil at [https://xss.vavkamil.cz/blog/2021-11-25-wordpress-plugin-confusion-update-can-get-you-pwned.html](https://xss.vavkamil.cz/blog/2021-11-25-wordpress-plugin-confusion-update-can-get-you-pwned.html)
...
1. ```[i] Not vulnerable - {{Explanation}}``` - which means we can't claim the plugin for vairous of reasons (already claimed, pro version and more...)

2. ```[i] Found WP plugin: redacted-blocks
